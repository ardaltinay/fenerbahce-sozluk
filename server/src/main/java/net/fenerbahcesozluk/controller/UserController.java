...
public class UserController {
    ...
    public ResponseEntity<Map<String, String>> suspendOwnAccount(@Valid @RequestBody DeleteAccountRequest request,
            @AuthenticationPrincipal User currentUser) {
        // Reusing DeleteAccountRequest for password validation
        userService.suspendOwnAccount(currentUser, request.getPassword());

        return ResponseEntity.ok(Map.of("message", "Hesabınız askıya alındı"));
    }
    ...
    @PostMapping("/{id}/ban")
    public ResponseEntity<Map<String, String>> banUser(@PathVariable UUID id, @RequestBody Map<String, Object> body,
            @AuthenticationPrincipal User currentUser) {
    ...
    public ResponseEntity<Map<String, String>> promoteToModerator(@PathVariable UUID id,
            @AuthenticationPrincipal User currentUser) {
    ...
    public ResponseEntity<Map<String, String>> demoteToUser(@PathVariable UUID id,
            @AuthenticationPrincipal User currentUser) {
